...
```{r mvn, fig.cap = "MVN diagnostic panel for `brittany_soil_ps`. Histograms (blue = SW pass) with fitted normal curves, and chi-square Q-Q plot.", fig.height = 6, fig.width = 6.9}
...
Morvan, T., Lambert, Y., Germain, P., Lemercier, B., Moreira, M. and Beff, L. (2023). A dataset of physico-chemical properties, extractable organic N, N mineralisation and physical organic matter fractionation
